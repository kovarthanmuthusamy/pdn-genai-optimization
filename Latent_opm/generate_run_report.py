"""Generate a Markdown run-report for a latent optimisation run.

Usage (standalone):
    python Latent_opm/generate_run_report.py <run_folder>

Called automatically by latent_optimization_impedance.py at the end of a run.
"""
...
def main() -> None:
    if len(sys.argv) < 2:
        print("Usage: python generate_run_report.py <run_folder>")
        sys.exit(1)
