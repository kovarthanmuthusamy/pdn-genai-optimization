"""Shared helpers for latent-opt → scrap export, PEB, and impedance compare."""
...
def move_pi_from_emc(
    ...
    *,
    ...
    import scrap.move_pi_to_real as mpi
...
def write_compare_report(
    ...
    *,
    ...
    if include_config:
        from Latent_opm.generate_run_report import build_report
