...
GP opt-in: `active_learning_pi/config/exp057_gp_error.json` (`acquisition_mode: "gp_error"`) — see [gp-error-surrogate.md](./gp-error-surrogate.md).
...
Package details: [`../active_learning_pi/README.md`](../active_learning_pi/README.md).
