...
Details and file roles: [dataset.md](./dataset.md) §4.
...
Primary QC metrics for compare reports: [evaluation-metrics.md](./evaluation-metrics.md).
...
| [dataset.md](./dataset.md) | Dataset layout and anchors |
| [active-learning.md](./active-learning.md) | Selective sim inside AL cycles |
