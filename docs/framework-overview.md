...
| Chapter need | Doc |
|--------------|-----|
| Methods — model | [model-architecture.md](./model-architecture.md), [experiment-lineage.md](./experiment-lineage.md) |
| Methods — data / norm / loss | [dataset.md](./dataset.md), [normalization-and-losses.md](./normalization-and-losses.md) |
| Methods — inverse design | [latent-optimization.md](./latent-optimization.md), [impedance-surrogate.md](./impedance-surrogate.md) |
| Methods — AL | [active-learning.md](./active-learning.md), [gp-error-surrogate.md](./gp-error-surrogate.md) |
| Experiments / metrics | [evaluation-metrics.md](./evaluation-metrics.md), [evaluation-suite.md](./evaluation-suite.md) |
| Threats to validity | [limitations-and-validity.md](./limitations-and-validity.md) |
| Pipelines | [data-pipeline.md](./data-pipeline.md), [training-procedure.md](./training-procedure.md) |
