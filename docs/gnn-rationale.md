...
Implementation: `graph_occ.py`, `graph_imp.py` under `experiments/exp057_structured_graph/codes/` (occ GNN first landed in exp056). Broader architecture: [model-architecture.md](./model-architecture.md).
...
| Doc | Role |
|-----|------|
| [model-architecture.md](./model-architecture.md) | Full exp054→057 stack |
| [experiment-lineage.md](./experiment-lineage.md) | Where 056/057 sit vs 058/059 |
| [evaluation-metrics.md](./evaluation-metrics.md) | How Pearson / FG MSE are defined |
