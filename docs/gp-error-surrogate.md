...
For the production MC-uncertainty AL loop (Option B), see [active-learning.md](./active-learning.md).
...
| Gap | Mitigation |
|-----|------------|
| No proof GP beats random | [`validate_acquisition_ab.py`](../active_learning_pi/al/validate_acquisition_ab.py) — labeled holdout A/B (**defaults to exp059**) |
...
Implementation: [`../active_learning_pi/al/gp_error_surrogate.py`](../active_learning_pi/al/gp_error_surrogate.py) + hook in [`../active_learning_pi/al/inference_pool.py`](../active_learning_pi/al/inference_pool.py).
