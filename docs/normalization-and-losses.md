...
Originally developed and documented around **exp050**; the same normalization family and Tier-A loss principles carry into **exp054–exp057**. Later additions (hard occupancy decode, top-region Huber) are summarized in [model-architecture.md](./model-architecture.md).
