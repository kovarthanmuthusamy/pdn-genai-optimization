...
Condensed description of the training loop used by the self-contained multi-input VAE trainers. Written from the exp054 process; **exp055–exp057** keep the same loop structure with architecture and loss deltas documented in [model-architecture.md](./model-architecture.md).
...
- For AL fine-tunes, report base epoch, overlay weight, and extra epochs ([active-learning.md](./active-learning.md)).
