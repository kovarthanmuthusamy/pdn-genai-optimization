...
PEB path: `experiments/exp039_improved_heatmap/multifreq_heatmap_sweep_k=24/pi_distribution_K5_freq_sweep.peb` (PI-Distribution only, no PI-Spectrum).
...
- `experiments/exp039_improved_heatmap/multifreq_heatmap_sweep_k=24/generate_summary.csv`
- `experiments/exp039_improved_heatmap/multifreq_heatmap_sweep_k=24/generate_heatmap_vs_mhz.png`
- `experiments/exp039_improved_heatmap/multifreq_heatmap_sweep_k=24/pi_distribution_K5_freq_sweep.peb`
