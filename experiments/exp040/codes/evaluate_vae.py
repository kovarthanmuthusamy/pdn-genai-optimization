...
# =============================================================================
# CONFIGURATION — edit these before running: python experiments/exp040/codes/evaluate_vae.py
# =============================================================================

CHECKPOINT: str | None = None  # None = use config.yaml default / last_model.pt
OUTPUT_DIR: str | None = None  # None = eval_results under experiment dir
