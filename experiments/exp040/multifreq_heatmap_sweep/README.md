...
Checkpoint: `experiments/exp040/checkpoints/last_model.pt`
Fixed K: **5**
...
PEB path: `experiments/exp040/multifreq_heatmap_sweep/pi_distribution_K5_freq_sweep.peb` (PI-Distribution only, no PI-Spectrum).
...
- `experiments/exp040/multifreq_heatmap_sweep/generate_summary.csv`
- `experiments/exp040/multifreq_heatmap_sweep/generate_heatmap_vs_mhz.png`
- `experiments/exp040/multifreq_heatmap_sweep/pi_distribution_K5_freq_sweep.peb`
