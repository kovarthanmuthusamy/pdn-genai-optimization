...
from experiments.exp041.codes.metrics_csv_utils import (  # noqa: E402
    insert_epoch_row,
...
def main() -> None:
    ap = argparse.ArgumentParser(description="Backfill epoch 1 and/or rebuild exp041 plots from loss.csv")
    ap.add_argument(
        "--plots-only",
        action="store_true",
