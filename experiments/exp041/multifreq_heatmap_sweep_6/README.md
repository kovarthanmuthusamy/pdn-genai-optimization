...
PEB path: `experiments/exp041/multifreq_heatmap_sweep_6/pi_distribution_K6_freq_sweep.peb` (PI-Distribution only, no PI-Spectrum).
...
- `experiments/exp041/multifreq_heatmap_sweep_6/generate_summary.csv`
- `experiments/exp041/multifreq_heatmap_sweep_6/generate_heatmap_vs_mhz.png`
- `experiments/exp041/multifreq_heatmap_sweep_6/pi_distribution_K6_freq_sweep.peb`
