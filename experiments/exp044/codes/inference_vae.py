"""
Inference script for Multi-Input VAE — exp044.
...
from experiments.exp044.codes.vae_poe_freq import MultiInputVAEPoeFreq  # noqa: E402
...
class VAEInference:
    """Inference engine for exp044 multifreq PI heatmap VAE."""
