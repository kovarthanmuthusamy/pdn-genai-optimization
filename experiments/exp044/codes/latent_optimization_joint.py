#!/usr/bin/env python3
"""Joint latent optimization: heatmap + impedance (exp044, log1p z-score norm).
...
from experiments.exp044.codes.exp044_eval_common import load_model, resolve_paths  # noqa: E402
...
def main() -> None:
    ap = argparse.ArgumentParser(description="exp044 joint heatmap+impedance latent optimization")
