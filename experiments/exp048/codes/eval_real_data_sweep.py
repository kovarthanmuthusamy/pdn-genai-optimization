...
Run:
  ...
  python -m experiments.exp048.codes.eval_real_data_sweep
"""
...
from experiments.exp048.codes.exp048_eval_common import (
    load_exp_config,
    load_model,
    pi_norm_to_mhz,
    resolve_paths,
)
from experiments.exp048.codes.spatial_metrics import peak_loc_err, pearson_fg
    ...
    *,
    ...
    for bi, batch in enumerate(val_loader):
        ...
        for target_mhz in eval_mhz:
            ...
            hm_real_phys = hm_stats.norm_to_physical(hm_sel, pi_norm=pi_sel, apply_clip=True)
            ...
            for kind, recon in (("encode", rh_enc), ("layout", rh_lay)):
                ...
                recon_phys = hm_stats.norm_to_physical(recon, pi_norm=pi_sel, apply_clip=True)
