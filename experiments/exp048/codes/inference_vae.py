...
from experiments.exp048.codes.vae_poe_freq import MultiInputVAEPoeFreq  # noqa: E402
...
class VAEInference:
    """Inference engine for exp048 multifreq PI heatmap VAE."""
    ...
    def denorm_heatmap_physical(
        ...
        *,
        ...
        return self.hm_stats.norm_to_physical(
            hm_norm, mhz=mhz, pi_norm=pi_norm, apply_clip=True,
        )
