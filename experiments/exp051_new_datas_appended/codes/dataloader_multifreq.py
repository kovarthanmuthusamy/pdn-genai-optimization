...
from experiments.exp051_new_datas_appended.codes.sampler_curriculum import (
...
def create_multifreq_data_loaders(
    ...
    *,
    ...
    if curriculum_sampler is not None:
        train_loader.exp051_curriculum_sampler = curriculum_sampler  # type: ignore[attr-defined]
