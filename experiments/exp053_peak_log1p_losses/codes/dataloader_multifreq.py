...
from experiments.exp053_peak_log1p_losses.codes.sampler_curriculum import (
...
def create_multifreq_data_loaders(
    ...
    *,
    ...
    if curriculum_sampler is not None:
        train_loader.exp053_curriculum_sampler = curriculum_sampler  # type: ignore[attr-defined]
