...
os.environ.setdefault("VAE_EXPERIMENT_DIR", "experiments/exp054_K_30")
...
from experiments.exp054_K_30.codes.run_epoch_encode import (
    _cross_freq_decode,
    _forward_train_batch,
)
from experiments.exp054_K_30.codes.train_vae_simple import (
    Config,
    _patch_training,
    build_vae_model,
)
from experiments.exp054_K_30.codes.training_guard import (
    clamp_logvar,
