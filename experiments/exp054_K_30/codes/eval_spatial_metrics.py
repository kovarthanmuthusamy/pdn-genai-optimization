...
from experiments.exp054_K_30.codes.spatial_metrics import peak_loc_err, pearson_fg
    ...
    for bi, batch in enumerate(val_loader):
        ...
        for mhz in off_anchor_mhz:
            ...
            rh_enc, _, _ = base.decode(
                z_enc_native, K, pi_t, occupancy=occ, heatmap_skips=skips_native if use_encode_skips else None,
            )
