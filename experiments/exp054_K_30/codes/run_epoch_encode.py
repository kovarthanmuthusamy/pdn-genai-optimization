"""exp054 training epoch — layout path + log1p peak/valley."""

from __future__ import annotations
from typing import Any
import torch
import experiments.exp054_K_30.codes.train_core as _tr
from experiments.exp054_K_30.codes.train_core import (
    Config, _amp_dtype, _cross_modal, _jitter_pi_freq_norm, _penalty_scale, _phase_weights, _prepare_batch,
)
from experiments.exp054_K_30.codes.distributed_train import unwrap_model
from experiments.exp054_K_30.codes.training_guard import clamp_logvar, prepare_recon_for_loss, safe_train_step, sanitize_loss_dict
...
def _use_amp(c: Config, *, train: bool) -> bool:
    if train:
        return False  # exp054: full fp32 train avoids AMP backward NaNs
