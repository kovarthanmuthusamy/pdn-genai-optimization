...
os.environ.setdefault("VAE_EXPERIMENT_DIR", "experiments/exp055_hard_occ")
...
from experiments.exp055_hard_occ.codes.run_epoch_encode import (
    _cross_freq_decode,
    _forward_train_batch,
)
from experiments.exp055_hard_occ.codes.train_vae_simple import (
    Config,
    _patch_training,
    build_vae_model,
)
from experiments.exp055_hard_occ.codes.training_guard import (
    clamp_logvar,
