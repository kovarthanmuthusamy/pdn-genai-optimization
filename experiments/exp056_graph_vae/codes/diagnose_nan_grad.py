...
os.environ.setdefault("VAE_EXPERIMENT_DIR", "experiments/exp056_graph_vae")
...
from experiments.exp056_graph_vae.codes.run_epoch_encode import (
    _cross_freq_decode,
    _forward_train_batch,
)
from experiments.exp056_graph_vae.codes.train_vae_simple import (
    Config,
    _patch_training,
    build_vae_model,
)
from experiments.exp056_graph_vae.codes.training_guard import (
    clamp_logvar,
