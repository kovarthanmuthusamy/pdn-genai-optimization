...
from experiments.exp056_graph_vae.codes.graph_occ import OccGraphDecoder, OccGraphEncoder
...
class MultiInputVAE(nn.Module):
    ...
    def decode(
        ...
        if occupancy is not None and getattr(self, "binary_occupancy_decode", False):
            from experiments.exp056_graph_vae.codes.occupancy_binary import occupancy_for_heatmap_decode
