...
from experiments.exp058_asymmetric_kl.codes.graph_occ import OccGraphDecoder, OccGraphEncoder
from experiments.exp058_asymmetric_kl.codes.graph_imp import ImpSpectrumGraphDecoder, ImpSpectrumGraphEncoder
...
class MultiInputVAE(nn.Module):
    ...
    def decode(
        ...
        if occupancy is not None and getattr(self, "binary_occupancy_decode", False):
            from experiments.exp058_asymmetric_kl.codes.occupancy_binary import occupancy_for_heatmap_decode
