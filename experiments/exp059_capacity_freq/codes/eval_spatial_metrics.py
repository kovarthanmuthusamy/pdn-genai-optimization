...
from experiments.exp059_capacity_freq.codes.spatial_metrics import peak_loc_err, pearson_fg
...
def run_off_anchor_eval_spatial(
    ...
    *,
    ...
    model.eval()
    from experiments.exp059_capacity_freq.codes.distributed_train import unwrap_model
    ...
    for bi, batch in enumerate(val_loader):
        ...
        for mhz in off_anchor_mhz:
            ...
            rh_enc, _, _ = base.decode(z_enc_native, K, pi_t, occupancy=occ_dec)
