"""
Inference script for Multi-Input VAE — exp059 (no U-Net skips).
...
from experiments.exp059_capacity_freq.codes.exp059_common import vae_model_kwargs  # noqa: E402
from experiments.exp059_capacity_freq.codes.vae_poe_freq import MultiInputVAEPoeFreq  # noqa: E402
...
class VAEInference:
    """Inference engine for exp059 multifreq PI heatmap VAE (no U-Net skips)."""
    ...
    def __init__(
        ...
        if skipped:
            raise RuntimeError(
                f"Checkpoint has {len(skipped)} tensors that do not match the exp059 model "
