...
title: dataset
type: concept
source: docs/dataset.md
tags: [concept, thesis]
---

> [!info] Mirror of `docs/dataset.md` — edit the source file, then re-run `tools/build_vault.py`.
...
- Off-anchor generalization (between anchors) is both a **data density** and a **model** issue; AL targets the latter with selective new sims ([[active-learning|active-learning.md]]).


## Implemented by

- [[processing_multifreq]] — `pipelines/data/processing_multifreq.py`
- [[dataset_meta]] — `libs/dataset_meta.py`
- [[experiments.exp059_capacity_freq.codes.dataloader_multifreq]] — `experiments/exp059_capacity_freq/codes/dataloader_multifreq.py`
