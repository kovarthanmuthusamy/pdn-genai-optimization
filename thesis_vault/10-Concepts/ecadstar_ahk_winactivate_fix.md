---
title: ecadstar_ahk_winactivate_fix
type: concept
source: docs/ecadstar_ahk_winactivate_fix.md
tags: [concept, thesis]
---

> [!info] Mirror of `docs/ecadstar_ahk_winactivate_fix.md` — edit the source file, then re-run `tools/build_vault.py`.
...
> automation). See [[ecadstar_headless_cli|`ecadstar_headless_cli.md`]]. Kept
