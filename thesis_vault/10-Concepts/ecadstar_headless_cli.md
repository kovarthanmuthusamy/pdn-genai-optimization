---
title: ecadstar_headless_cli
type: concept
source: docs/ecadstar_headless_cli.md
tags: [concept, thesis]
---

> [!info] Mirror of `docs/ecadstar_headless_cli.md` — edit the source file, then re-run `tools/build_vault.py`.
