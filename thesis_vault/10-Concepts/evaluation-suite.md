...
type: concept
source: docs/evaluation-suite.md
tags: [concept, thesis]
---

> [!info] Mirror of `docs/evaluation-suite.md` — edit the source file, then re-run `tools/build_vault.py`.
...
| Gen vs ECAD sweep QC | Sim-compare primary metrics — [[evaluation-metrics|evaluation-metrics.md]] |
| AL cycle pre/post | `CYCLE_EVAL_REPORT.md` — [[active-learning|active-learning.md]] |
...
- [[evaluation-metrics|evaluation-metrics.md]] — primary QC definitions  
- [[limitations-and-validity|limitations-and-validity.md]] — threats  
- [[gp-error-surrogate|gp-error-surrogate.md]] — residual ranking validation


## Implemented by

- [[evaluate_report]] — `active_learning_pi/al/evaluate_report.py`
- [[evaluate_off_anchor]] — `active_learning_pi/al/evaluate_off_anchor.py`
- [[evaluate_hole_finding]] — `active_learning_pi/al/evaluate_hole_finding.py`
