---
title: impedance-surrogate
type: concept
source: docs/impedance-surrogate.md
tags: [concept, thesis]
---

> [!info] Mirror of `docs/impedance-surrogate.md` — edit the source file, then re-run `tools/build_vault.py`.
