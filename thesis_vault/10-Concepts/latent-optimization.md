...
type: concept
source: docs/latent-optimization.md
tags: [concept, thesis]
---

> [!info] Mirror of `docs/latent-optimization.md` — edit the source file, then re-run `tools/build_vault.py`.
...
**Related:** [[impedance-surrogate|impedance-surrogate.md]], [[framework-overview|framework-overview.md]]
...
- [[find_feasible]] — `pipelines/latent/find_feasible.py`
- [[optimization_loader]] — `pipelines/latent/optimization_loader.py`
- [[generate_run_report]] — `pipelines/latent/generate_run_report.py`
