---
title: multitype_peb_pipeline
type: concept
source: docs/multitype_peb_pipeline.md
tags: [concept, thesis]
---

> [!info] Mirror of `docs/multitype_peb_pipeline.md` — edit the source file, then re-run `tools/build_vault.py`.
...
- [[experiments.exp060_multitype_occ.codes.occupancy_binary]] — `experiments/exp060_multitype_occ/codes/occupancy_binary.py`
