---
title: NORMALIZATION_AND_LOSS_STRATEGIES (archived)
type: archive
source: docs/_archive/NORMALIZATION_AND_LOSS_STRATEGIES.md
tags: [archive]
---

> [!caution] Archived implementation note — not for thesis citation.

# Normalization and Heatmap Loss Strategies (exp050)

Technical reference for the GAN/VAE multifreq PI heatmap pipeline: **why** each design choice was made, **what** it does mathematically, **limitations**, comparisons, and a **literature review**.
...
| Tier A losses | `experiments/exp050/codes/heatmap_peak_losses.py` |
| Training loop | `experiments/exp050/codes/run_epoch_encode.py` |
| Config | `experiments/exp050/config.yaml` |
