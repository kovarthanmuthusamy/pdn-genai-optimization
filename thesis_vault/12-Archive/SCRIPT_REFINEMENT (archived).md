---
title: SCRIPT_REFINEMENT (archived)
type: archive
source: docs/_archive/SCRIPT_REFINEMENT.md
tags: [archive]
---
...
Scripts live under **`pipelines/`** and **`libs/`** only. Legacy shims were **removed** — use canonical paths (see [[Docs Index|`pipelines/README.md`]]).
