...
status: historical
era: vae
tags: [experiment, exp042, historical, era-vae]
---

# exp042

**Lineage:** [[exp041]] → **exp042** → [[exp043]]
**Status:** historical · **Era:** VAE era (9 Python files)
...
| `resume_checkpoint` | `experiments/exp042/checkpoints/checkpoint_epoch_700.pt` |

*Full config: `experiments/exp042/config.yaml` (136 keys)*

## Notes (from `experiments/exp042/notes.md`)
...
- [[experiments.exp042.codes.__init__]]
- [[experiments.exp042.codes.evaluate_vae]] — evaluate_vae.py — Post-training evaluation for exp042 (PI_freq-conditioned VAE).
- [[exp042_eval_common]] — Shared paths, model loading, and PI_freq helpers for exp042 evaluation scripts.
- [[experiments.exp042.codes.inference_vae]] — Inference script for Multi-Input VAE — exp042.
- [[experiments.exp042.codes.metrics_csv_utils]] — Read/write exp042 metrics CSVs (dedupe by epoch, sorted).
- [[experiments.exp042.codes.synthetic_freq_blend]] — Synthetic between-anchor heatmap targets for multifreq training (exp042).
- [[experiments.exp042.codes.train_vae_simple]] — Train VAE for exp042 — PI_freq PoE expert on heatmap-private dims.
- [[experiments.exp042.codes.vae_poe_freq]] — Multi-input VAE with PI_freq as a dedicated PoE expert (exp042).
- [[experiments.exp042.codes.visualize_latent]] — visualize_latent.py — Latent space visualizations for exp042 (PI_freq-conditioned VAE).

## Metrics artifacts

`experiments/exp042/metrics/`
