...
title: inference_vae
type: code
path: experiments/exp038_true_multi/codes/inference_vae.py
...
**Source:** `experiments/exp038_true_multi/codes/inference_vae.py` · 353 lines
**Experiment:** [[exp038_true_multi]]
**Runnable:** CONFIG-only script — edit constants at top, then `python experiments/exp038_true_multi/codes/inference_vae.py`
