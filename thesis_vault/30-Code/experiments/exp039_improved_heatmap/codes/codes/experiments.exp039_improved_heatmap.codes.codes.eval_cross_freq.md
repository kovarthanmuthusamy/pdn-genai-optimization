...
type: code
path: experiments/exp039_improved_heatmap/codes/codes/eval_cross_freq.py
...
**Source:** `experiments/exp039_improved_heatmap/codes/codes/eval_cross_freq.py` · 237 lines
**Experiment:** [[exp039_improved_heatmap]]
**Runnable:** CONFIG-only script — edit constants at top, then `python experiments/exp039_improved_heatmap/codes/codes/eval_cross_freq.py`
...
Run:
    python experiments/exp039_improved_heatmap/codes/eval_cross_freq.py
...
| `EXP_DIR` | `PROJECT_ROOT / 'experiments/exp039_improved_heatmap'` |
