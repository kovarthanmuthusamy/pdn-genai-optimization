...
title: evaluate_vae
type: code
path: experiments/exp039_improved_heatmap/codes/evaluate_vae.py
...
**Source:** `experiments/exp039_improved_heatmap/codes/evaluate_vae.py` · 384 lines
**Experiment:** [[exp039_improved_heatmap]]
...
Usage:
    ...
    python experiments/exp039_improved_heatmap/codes/evaluate_vae.py --ckpt checkpoints/last_model.pt
```
