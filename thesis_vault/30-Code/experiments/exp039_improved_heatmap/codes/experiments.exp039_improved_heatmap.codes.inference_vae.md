...
title: inference_vae
type: code
path: experiments/exp039_improved_heatmap/codes/inference_vae.py
...
> Inference script for Multi-Input VAE — exp039_improved_heatmap.

**Source:** `experiments/exp039_improved_heatmap/codes/inference_vae.py` · 435 lines
**Experiment:** [[exp039_improved_heatmap]]
**Runnable:** CONFIG-only script — edit constants at top, then `python experiments/exp039_improved_heatmap/codes/inference_vae.py`
...
- **`VAEInference`** — Inference engine for exp039 multifreq PI heatmap VAE.
