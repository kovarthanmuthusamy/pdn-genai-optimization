...
type: code
path: experiments/exp039_improved_heatmap/codes/visualize_latent.py
...
**Source:** `experiments/exp039_improved_heatmap/codes/visualize_latent.py` · 347 lines
**Experiment:** [[exp039_improved_heatmap]]
**Runnable:** CONFIG-only script — edit constants at top, then `python experiments/exp039_improved_heatmap/codes/visualize_latent.py`
...
`exp039_eval_common`, `matplotlib`, `numpy`, `sklearn`, `torch`
