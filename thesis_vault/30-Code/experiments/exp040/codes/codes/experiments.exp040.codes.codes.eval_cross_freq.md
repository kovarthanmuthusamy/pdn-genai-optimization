...
type: code
path: experiments/exp040/codes/codes/eval_cross_freq.py
...
**Source:** `experiments/exp040/codes/codes/eval_cross_freq.py` · 237 lines
**Experiment:** [[exp040]]
**Runnable:** CONFIG-only script — edit constants at top, then `python experiments/exp040/codes/codes/eval_cross_freq.py`
...
Run:
    python experiments/exp040/codes/eval_cross_freq.py
...
| `EXP_DIR` | `PROJECT_ROOT / 'experiments/exp040'` |
