...
title: inference_vae
type: code
path: experiments/exp040/codes/codes/inference_vae.py
...
**Source:** `experiments/exp040/codes/codes/inference_vae.py` · 353 lines
**Experiment:** [[exp040]]
**Runnable:** CONFIG-only script — edit constants at top, then `python experiments/exp040/codes/codes/inference_vae.py`
