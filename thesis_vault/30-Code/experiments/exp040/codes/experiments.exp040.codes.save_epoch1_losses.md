...
type: code
path: experiments/exp040/codes/save_epoch1_losses.py
...
**Source:** `experiments/exp040/codes/save_epoch1_losses.py` · 265 lines
**Experiment:** [[exp040]]
**Runnable:** CONFIG-only script — edit constants at top, then `python experiments/exp040/codes/save_epoch1_losses.py`
