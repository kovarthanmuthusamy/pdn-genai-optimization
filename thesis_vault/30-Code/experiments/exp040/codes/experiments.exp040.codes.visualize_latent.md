...
type: code
path: experiments/exp040/codes/visualize_latent.py
...
**Source:** `experiments/exp040/codes/visualize_latent.py` · 347 lines
**Experiment:** [[exp040]]
**Runnable:** CONFIG-only script — edit constants at top, then `python experiments/exp040/codes/visualize_latent.py`
...
Run:
    python experiments/exp040/codes/visualize_latent.py
```
