...
type: code
path: experiments/exp041/codes/codes/eval_val_recon.py
...
**Source:** `experiments/exp041/codes/codes/eval_val_recon.py` · 155 lines
**Experiment:** [[exp041]]
**Runnable:** CONFIG-only script — edit constants at top, then `python experiments/exp041/codes/codes/eval_val_recon.py`
...
Run:
    python experiments/exp041/codes/eval_val_recon.py
