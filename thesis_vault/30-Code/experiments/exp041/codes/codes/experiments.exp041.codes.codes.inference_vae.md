...
title: inference_vae
type: code
path: experiments/exp041/codes/codes/inference_vae.py
...
**Source:** `experiments/exp041/codes/codes/inference_vae.py` · 353 lines
**Experiment:** [[exp041]]
**Runnable:** CONFIG-only script — edit constants at top, then `python experiments/exp041/codes/codes/inference_vae.py`
