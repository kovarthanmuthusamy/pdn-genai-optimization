...
title: evaluate_vae
type: code
path: experiments/exp041/codes/evaluate_vae.py
...
> evaluate_vae.py — Post-training evaluation for exp041 (PI_freq-conditioned VAE).

**Source:** `experiments/exp041/codes/evaluate_vae.py` · 384 lines
**Experiment:** [[exp041]]
...
Usage:
    ...
    python experiments/exp041/codes/evaluate_vae.py --ckpt checkpoints/last_model.pt
```
...
`exp041_eval_common`, `matplotlib`, `numpy`, `src_vae`, `torch`
