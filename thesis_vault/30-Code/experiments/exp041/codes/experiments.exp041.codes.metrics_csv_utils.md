...
type: code
path: experiments/exp041/codes/metrics_csv_utils.py
...
**Source:** `experiments/exp041/codes/metrics_csv_utils.py` · 121 lines
**Experiment:** [[exp041]]
...
- **`update_all_metrics_csv(metrics_dir: Path, *, backup: bool=True)`** — Dedupe all exp041 metrics CSVs that are epoch-indexed.
