...
type: code
path: experiments/exp041/codes/visualize_latent.py
...
> visualize_latent.py — Latent space visualizations for exp041 (PI_freq-conditioned VAE).

**Source:** `experiments/exp041/codes/visualize_latent.py` · 357 lines
**Experiment:** [[exp041]]
...
Usage:
    ...
    python experiments/exp041/codes/visualize_latent.py --ckpt checkpoints/last_model.pt
```
...
`exp041_eval_common`, `matplotlib`, `numpy`, `sklearn`, `torch`
