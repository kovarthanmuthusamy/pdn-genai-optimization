...
title: inference_vae
type: code
path: experiments/exp042/codes/inference_vae.py
group: experiments/exp042/codes
experiment: exp042
loc: 436
tags: [code, exp042, runnable]
---

# inference_vae

> Inference script for Multi-Input VAE — exp042.

**Source:** `experiments/exp042/codes/inference_vae.py` · 436 lines
**Experiment:** [[exp042]]
**Runnable:** CONFIG-only script — edit constants at top, then `python experiments/exp042/codes/inference_vae.py`
...
- **`VAEInference`** — Inference engine for exp042 multifreq PI heatmap VAE.
