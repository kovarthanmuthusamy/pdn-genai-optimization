...
type: code
path: experiments/exp042/codes/visualize_latent.py
...
**Source:** `experiments/exp042/codes/visualize_latent.py` · 357 lines
**Experiment:** [[exp042]]
...
`exp042_eval_common`, `matplotlib`, `numpy`, `sklearn`, `torch`
