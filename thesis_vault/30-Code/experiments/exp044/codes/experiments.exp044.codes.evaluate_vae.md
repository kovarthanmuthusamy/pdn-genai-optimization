...
title: evaluate_vae
type: code
path: experiments/exp044/codes/evaluate_vae.py
...
> evaluate_vae.py — Post-training evaluation for exp044 (PI_freq-conditioned VAE).

**Source:** `experiments/exp044/codes/evaluate_vae.py` · 384 lines
**Experiment:** [[exp044]]
...
Usage:
    python experiments/exp044/codes/evaluate_vae.py
    python experiments/exp044/codes/evaluate_vae.py --ckpt checkpoints/last_model.pt
```
...
`exp044_eval_common`, `matplotlib`, `numpy`, `src_vae`, `torch`
