...
title: inference_vae
type: code
path: experiments/exp044/codes/inference_vae.py
group: experiments/exp044/codes
experiment: exp044
loc: 450
tags: [code, exp044, runnable]
---
...
**Source:** `experiments/exp044/codes/inference_vae.py` · 450 lines
**Experiment:** [[exp044]]
**Runnable:** CONFIG-only script — edit constants at top, then `python experiments/exp044/codes/inference_vae.py`
...
- **`VAEInference`** — Inference engine for exp044 multifreq PI heatmap VAE.
