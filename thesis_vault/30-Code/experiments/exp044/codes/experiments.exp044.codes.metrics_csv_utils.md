...
type: code
path: experiments/exp044/codes/metrics_csv_utils.py
...
> Read/write exp044 metrics CSVs (dedupe by epoch, sorted).

**Source:** `experiments/exp044/codes/metrics_csv_utils.py` · 121 lines
**Experiment:** [[exp044]]
...
- **`update_all_metrics_csv(metrics_dir: Path, *, backup: bool=True)`** — Dedupe all exp044 metrics CSVs that are epoch-indexed.
