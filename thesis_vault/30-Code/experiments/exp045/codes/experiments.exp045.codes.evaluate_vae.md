...
title: evaluate_vae
type: code
path: experiments/exp045/codes/evaluate_vae.py
...
**Source:** `experiments/exp045/codes/evaluate_vae.py` · 384 lines
**Experiment:** [[exp045]]
...
`exp045_eval_common`, `matplotlib`, `numpy`, `src_vae`, `torch`
