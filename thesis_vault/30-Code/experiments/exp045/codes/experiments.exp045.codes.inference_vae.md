...
title: inference_vae
type: code
path: experiments/exp045/codes/inference_vae.py
group: experiments/exp045/codes
experiment: exp045
loc: 450
tags: [code, exp045, runnable]
---
...
**Source:** `experiments/exp045/codes/inference_vae.py` · 450 lines
**Experiment:** [[exp045]]
**Runnable:** CONFIG-only script — edit constants at top, then `python experiments/exp045/codes/inference_vae.py`
...
- **`VAEInference`** — Inference engine for exp045 multifreq PI heatmap VAE.
