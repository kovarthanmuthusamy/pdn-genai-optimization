...
type: code
path: experiments/exp045/codes/metrics_csv_utils.py
...
> Read/write exp045 metrics CSVs (dedupe by epoch, sorted).

**Source:** `experiments/exp045/codes/metrics_csv_utils.py` · 121 lines
**Experiment:** [[exp045]]
...
- **`update_all_metrics_csv(metrics_dir: Path, *, backup: bool=True)`** — Dedupe all exp045 metrics CSVs that are epoch-indexed.
