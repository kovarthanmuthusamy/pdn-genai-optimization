...
type: code
path: experiments/exp045/codes/visualize_latent.py
...
> visualize_latent.py — Latent space visualizations for exp045 (PI_freq-conditioned VAE).

**Source:** `experiments/exp045/codes/visualize_latent.py` · 357 lines
**Experiment:** [[exp045]]
...
Usage:
    cd ~/gan
    python experiments/exp045/codes/visualize_latent.py
    python experiments/exp045/codes/visualize_latent.py --ckpt checkpoints/last_model.pt
```
...
`exp045_eval_common`, `matplotlib`, `numpy`, `sklearn`, `torch`
