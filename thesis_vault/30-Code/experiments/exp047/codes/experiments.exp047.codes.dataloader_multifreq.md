...
type: code
path: experiments/exp047/codes/dataloader_multifreq.py
...
> exp047 multifreq dataloader — bias cross-freq alt pairs toward high MHz.

**Source:** `experiments/exp047/codes/dataloader_multifreq.py` · 213 lines
**Experiment:** [[exp047]]
