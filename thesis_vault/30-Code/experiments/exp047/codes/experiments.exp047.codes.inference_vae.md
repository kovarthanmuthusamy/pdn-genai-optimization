...
title: inference_vae
type: code
path: experiments/exp047/codes/inference_vae.py
group: experiments/exp047/codes
experiment: exp047
loc: 458
tags: [code, exp047, runnable]
---
...
**Source:** `experiments/exp047/codes/inference_vae.py` · 458 lines
**Experiment:** [[exp047]]
**Runnable:** CONFIG-only script — edit constants at top, then `python experiments/exp047/codes/inference_vae.py`
...
- **`VAEInference`** — Inference engine for exp047 multifreq PI heatmap VAE.
