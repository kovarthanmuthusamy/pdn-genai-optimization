...
type: code
path: experiments/exp048/codes/dataloader_multifreq.py
...
> exp048 multifreq dataloader — bias cross-freq alt pairs toward high MHz.

**Source:** `experiments/exp048/codes/dataloader_multifreq.py` · 213 lines
**Experiment:** [[exp048]]
