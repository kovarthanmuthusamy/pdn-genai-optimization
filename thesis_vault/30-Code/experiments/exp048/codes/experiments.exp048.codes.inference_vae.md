...
title: inference_vae
type: code
path: experiments/exp048/codes/inference_vae.py
group: experiments/exp048/codes
experiment: exp048
loc: 458
tags: [code, exp048, runnable]
---

# inference_vae

> Inference script for Multi-Input VAE — exp048.

**Source:** `experiments/exp048/codes/inference_vae.py` · 458 lines
**Experiment:** [[exp048]]
**Runnable:** CONFIG-only script — edit constants at top, then `python experiments/exp048/codes/inference_vae.py`
...
- **`VAEInference`** — Inference engine for exp048 multifreq PI heatmap VAE.
