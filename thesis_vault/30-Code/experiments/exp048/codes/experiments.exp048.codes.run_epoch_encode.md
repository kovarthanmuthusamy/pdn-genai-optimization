...
type: code
path: experiments/exp048/codes/run_epoch_encode.py
...
**Source:** `experiments/exp048/codes/run_epoch_encode.py` · 501 lines
**Experiment:** [[exp048]]

## Functions

- **`_heatmap_phys_amplitude_loss(recon: torch.Tensor, target: torch.Tensor, c: Config, *, pi_freq: torch.Tensor | None=None)`** — Foreground p99 in physical Ω — uses centralized norm_stats when available.
