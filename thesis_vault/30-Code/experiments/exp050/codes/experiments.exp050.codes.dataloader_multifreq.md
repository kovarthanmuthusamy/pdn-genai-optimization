...
type: code
path: experiments/exp050/codes/dataloader_multifreq.py
...
> exp050 multifreq dataloader — bias cross-freq alt pairs toward high MHz.

**Source:** `experiments/exp050/codes/dataloader_multifreq.py` · 213 lines
**Experiment:** [[exp050]]
