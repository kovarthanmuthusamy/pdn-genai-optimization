...
title: inference_vae
type: code
path: experiments/exp050/codes/inference_vae.py
group: experiments/exp050/codes
experiment: exp050
loc: 458
tags: [code, exp050, runnable]
---

# inference_vae

> Inference script for Multi-Input VAE — exp050.

**Source:** `experiments/exp050/codes/inference_vae.py` · 458 lines
**Experiment:** [[exp050]]
**Runnable:** CONFIG-only script — edit constants at top, then `python experiments/exp050/codes/inference_vae.py`
...
- **`VAEInference`** — Inference engine for exp050 multifreq PI heatmap VAE.
