...
type: code
path: experiments/exp051_new_datas_appended/codes/dataloader_multifreq.py
...
> exp051 multifreq dataloader — high-MHz cross-freq bias + append-tag curriculum sampling.

**Source:** `experiments/exp051_new_datas_appended/codes/dataloader_multifreq.py` · 260 lines
**Experiment:** [[exp051_new_datas_appended]]
