...
title: inference_vae
type: code
path: experiments/exp051_new_datas_appended/codes/inference_vae.py
group: experiments/exp051_new_datas_appended/codes
experiment: exp051_new_datas_appended
loc: 458
tags: [code, exp051_new_datas_appended, runnable]
---

# inference_vae

> Inference script for Multi-Input VAE — exp051.

**Source:** `experiments/exp051_new_datas_appended/codes/inference_vae.py` · 458 lines
**Experiment:** [[exp051_new_datas_appended]]
**Runnable:** CONFIG-only script — edit constants at top, then `python experiments/exp051_new_datas_appended/codes/inference_vae.py`
...
- **`VAEInference`** — Inference engine for exp051 multifreq PI heatmap VAE.
