...
type: code
path: experiments/exp051_new_datas_appended/codes/visualize_latent.py
...
> visualize_latent.py — Latent space visualizations for exp051_new_datas_appended (PI_freq-conditioned VAE).

**Source:** `experiments/exp051_new_datas_appended/codes/visualize_latent.py` · 357 lines
**Experiment:** [[exp051_new_datas_appended]]
...
Usage:
    cd ~/gan
    python experiments/exp051_new_datas_appended/codes/visualize_latent.py
    python experiments/exp051_new_datas_appended/codes/visualize_latent.py --ckpt checkpoints/last_model.pt
```
...
`exp051_eval_common`, `matplotlib`, `numpy`, `sklearn`, `torch`
