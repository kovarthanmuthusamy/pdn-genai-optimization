...
title: inference_vae
type: code
path: experiments/exp052_unbounded_pearson/codes/inference_vae.py
group: experiments/exp052_unbounded_pearson/codes
experiment: exp052_unbounded_pearson
loc: 458
tags: [code, exp052_unbounded_pearson, runnable]
---
...
**Source:** `experiments/exp052_unbounded_pearson/codes/inference_vae.py` · 458 lines
**Experiment:** [[exp052_unbounded_pearson]]
**Runnable:** CONFIG-only script — edit constants at top, then `python experiments/exp052_unbounded_pearson/codes/inference_vae.py`
...
- **`VAEInference`** — Inference engine for exp052 multifreq PI heatmap VAE.
