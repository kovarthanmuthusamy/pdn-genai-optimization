...
title: inference_vae
type: code
path: experiments/exp053_peak_log1p_losses/codes/inference_vae.py
group: experiments/exp053_peak_log1p_losses/codes
experiment: exp053_peak_log1p_losses
loc: 458
tags: [code, exp053_peak_log1p_losses, runnable]
---
...
**Source:** `experiments/exp053_peak_log1p_losses/codes/inference_vae.py` · 458 lines
**Experiment:** [[exp053_peak_log1p_losses]]
**Runnable:** CONFIG-only script — edit constants at top, then `python experiments/exp053_peak_log1p_losses/codes/inference_vae.py`
...
- **`VAEInference`** — Inference engine for exp053 multifreq PI heatmap VAE.
