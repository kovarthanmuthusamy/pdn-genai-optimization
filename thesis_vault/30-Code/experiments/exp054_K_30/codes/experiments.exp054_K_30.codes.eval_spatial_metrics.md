...
type: code
path: experiments/exp054_K_30/codes/eval_spatial_metrics.py
...
**Source:** `experiments/exp054_K_30/codes/eval_spatial_metrics.py` · 138 lines
**Experiment:** [[exp054_K_30]]
...
- **`run_off_anchor_eval_spatial(model: torch.nn.Module, val_loader, *, bg: float, off_anchor_mhz: tuple[float, ...]=(100.0, 270.0, 400.0), max_batches: int=12, device: str | torch.device='cuda', out_csv: Path | str | None=None, epoch: int=0, use_encode_skips: bool=False)`**
