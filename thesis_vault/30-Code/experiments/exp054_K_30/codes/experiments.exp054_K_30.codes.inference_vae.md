...
title: inference_vae
type: code
path: experiments/exp054_K_30/codes/inference_vae.py
group: experiments/exp054_K_30/codes
experiment: exp054_K_30
loc: 458
tags: [code, exp054_K_30, runnable]
---
...
**Source:** `experiments/exp054_K_30/codes/inference_vae.py` · 458 lines
**Experiment:** [[exp054_K_30]]
**Runnable:** CONFIG-only script — edit constants at top, then `python experiments/exp054_K_30/codes/inference_vae.py`
...
- **`VAEInference`** — Inference engine for exp054 multifreq PI heatmap VAE.
