...
title: inference_vae
type: code
path: experiments/exp056_graph_vae/codes/inference_vae.py
group: experiments/exp056_graph_vae/codes
experiment: exp056_graph_vae
loc: 458
tags: [code, exp056_graph_vae, runnable]
---
...
**Source:** `experiments/exp056_graph_vae/codes/inference_vae.py` · 458 lines
**Experiment:** [[exp056_graph_vae]]
**Runnable:** CONFIG-only script — edit constants at top, then `python experiments/exp056_graph_vae/codes/inference_vae.py`
