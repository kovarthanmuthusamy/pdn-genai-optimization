...
title: inference_vae
type: code
path: experiments/exp058_asymmetric_kl/codes/inference_vae.py
group: experiments/exp058_asymmetric_kl/codes
experiment: exp058_asymmetric_kl
loc: 458
tags: [code, exp058_asymmetric_kl, runnable, uncommitted]
---
...
**Source:** `experiments/exp058_asymmetric_kl/codes/inference_vae.py` · 458 lines
**Git:** uncommitted — not yet tracked
**Experiment:** [[exp058_asymmetric_kl]]
**Runnable:** CONFIG-only script — edit constants at top, then `python experiments/exp058_asymmetric_kl/codes/inference_vae.py`
