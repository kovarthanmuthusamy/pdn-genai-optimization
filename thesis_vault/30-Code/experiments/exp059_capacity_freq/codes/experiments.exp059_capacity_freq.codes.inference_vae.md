...
title: inference_vae
type: code
path: experiments/exp059_capacity_freq/codes/inference_vae.py
group: experiments/exp059_capacity_freq/codes
experiment: exp059_capacity_freq
loc: 484
tags: [code, exp059_capacity_freq, runnable, uncommitted]
---
...
**Source:** `experiments/exp059_capacity_freq/codes/inference_vae.py` · 484 lines
**Git:** uncommitted — not yet tracked
**Experiment:** [[exp059_capacity_freq]]
**Runnable:** CONFIG-only script — edit constants at top, then `python experiments/exp059_capacity_freq/codes/inference_vae.py`
...
- **`VAEInference`** — Inference engine for exp059 multifreq PI heatmap VAE (no U-Net skips).
