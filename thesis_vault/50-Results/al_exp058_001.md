...
title: al_exp058_001
type: result
tags: [result, active-learning, exp058_asymmetric_kl]
---

# al_exp058_001

**Path:** `active_learning_pi/runs/al_exp058_001/`
**Model:** [[exp058_asymmetric_kl]]
**Iterations:** 2 (iter_0001 … iter_0002)
...
|-------|---------|
| acq_direction | **PASS** |
| acq_ab_gp_vs_random | **UNCERTAIN** |
| ft_physical_improve | **FAIL** |
| eval_budget_trust | **PASS** |
| train_off_anchor_logged | **PASS** |

## Decision report

*Mirror of `active_learning_pi/runs/al_exp058_001/DECISION_REPORT.md`*
